...
#define BLUETOOTH_SLEEP             BIT0    // P3.0 (5994 Pin 04) (RF-BM-S02 module: P2.2)
#define BLUETOOTH_CONNECTED         BIT1    // P3.1 (5994 Pin 05) (RF-BM-S02 module: P2.1)
#define BLUETOOTH_RESET             BIT2    // P3.2 (5994 Pin 06) (RF-BM-S02 module: RES )
#define BLUETOOTH_EN                BIT3    // P3.3 (5994 Pin 07) (RF-BM-S02 module: P2.0)
...
#define BLUETOOTH_RESTORE           BIT7    // P4.7 (5994 Pin 12) (RF-BM-S02 module: P1.2)
